...
let headerUPK = `Статья 1. Законы, определяющие порядок уголовного судопроизводства
...
Статья 25.1. Прекращение уголовного дела или уголовного преследования в связи с назначением меры уголовно-правового характера в виде судебного штраф 
...
const Work = (function WorkFabric(){
	var array = headerUPK
		...
		.filter(c => !!c)
		.map(c => {
			let article = c.match(/Статья \d+\.?\d?\.?/g)[0]
